...
const registerUserCtrl = asyncHandler(async (req, res) => {
  ...
  /*
// Making the link
  const link = `${process.env.CLIENT_DOMAIN}/users/${user._id}/verify/${token}`;
...
//     }catch(error){  return res.status(400).json({ message: "invalid link" });}
...
const loginUserCtrl = asyncHandler(async (req, res) => {
  ...
  //    / http://localhost:5000/users/   const link = `http://localhost:5000/users/${user._id}/verify/${token}`
